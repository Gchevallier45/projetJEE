...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 10 mai 2019 à 00:16
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Address table';
...
CREATE TABLE IF NOT EXISTS `openinghours` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='OpeningHour table';
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COMMENT='Store table';
...
(1, 'coucou', 'cava', 'coucou@coucou.fr', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '0123456789', 1, '2019-03-23', '2019-03-23', 'mJlFjwJfSOnXMAx7qryMFlcrzYx9rwiHEiAOFaDmkxGLhJQUXmmy6yHG95wV', '2019-11-10', 0, 'camarche', 1, 1),
