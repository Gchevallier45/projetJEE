...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 10 mai 2019 à 09:15
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Address table';
...
CREATE TABLE IF NOT EXISTS `openinghours` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COMMENT='OpeningHour table';
...
CREATE TABLE IF NOT EXISTS `promotions` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Promotion table';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='Store table';
...
(5, '', '', '', '', 0, 0, '2019-05-09', 1, 1, 3),
(6, '', '', '', '', 0, 0, '2019-05-09', 1, 1, 5),
(8, '', '', '', '', 0, 0, '2019-05-10', 1, 1, 7),
(9, '', '', '', '', 0, 0, '2019-05-10', 1, 1, 8);
...
(1, 'coucou', 'cava', 'coucou@coucou.fr', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', '0123456789', 1, '2019-03-23', '2019-03-23', '2Q99k7nuQVpC8MgyLrUanrwubYsm0fXCrAYtXhaQtzen6jioVpyBfeenEFsv', '2019-11-10', 0, 'camarche', 1, 1),
