...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 29 avr. 2019 à 09:18
...
CREATE TABLE IF NOT EXISTS `addresses` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Address table';
...
CREATE TABLE IF NOT EXISTS `stores` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Store table';
...
(0, 'password', 'Magasin', '0123456789', 'Magasin@Magasin.fr', 47.3833, 0.683333, '2019-03-21', 1, 1);
...
CREATE TABLE IF NOT EXISTS `useraccounts` (
  ...
  `Address_id` int(11) NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='UserAccount table';
